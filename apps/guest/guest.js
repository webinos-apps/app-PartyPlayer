...
/*global $, jQuery, partyplayer, log, libUsers, profileIcons*/
//(function () {
    //"use strict";
    //define globals for user
    var userProfile = {
            userName : '',
            userPic : '',
            userID : ''
        ...
        selectLocalItems = {
            ...
            //loop through checked checkBoxes
                $.each($('input:checked'), function (i, item) {
                    ...
                    var itemKey = item.value,
                        sendItem = selectLocalItems.localItems[itemKey];
                    //send to host
            ...
            importItems: function (user) {
                var itemList = '';
                for (var i=0; i < libUsers.length; i += 1) {
        ...
        selectProfile = {
            profileClick: function (event) {
                ...
                var profileName = $('.profileName', this).html(),
                    profilePic = $('.profilePic', this).attr('src');
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    partyplayer.main.onupdateCollectionItem = function (param, ref) {
      ...
      //add items to screen
        var profileImage = '',
            trItem = '';
        trItem += '<tr class="current" user="' + param.userID + '" itemID="' + param.itemID + '">';
    ...
    partyplayer.funnel.onupdateFunnelItem = function (param, ref) {
        ...
        var item = $('table#partyCollection tr[itemID="' + param.itemID + '"]'),
            artist = item.find('.artist').html(),
            title = item.find('.title').html(),
            album = item.find('.album').html(),
            cover = item.find('.cover').html(),
